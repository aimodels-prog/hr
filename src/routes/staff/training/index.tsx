...
function StaffTrainingRoute() {
  ...
  useEffect(() => {
    ...
    allRecords.sort((a, b) => new Date(b.completionDate).getTime() - new Date(a.completionDate).getTime());
              ...
              <CardContent className="p-6 flex items-center justify-between">
                 <div className="flex-1">
                   <div className="flex items-center gap-3 mb-1">
                     <span className="font-semibold">{employees[record.employeeId] || "Unknown Employee"}</span>
