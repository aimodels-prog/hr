...
function PayrollPeriodsContent() {
  ...
  const handleCreate = () => {
    try {
      ...
      toast.error(error instanceof Error ? error.message : "Payroll period could not be created.");
    }
  };
                ...
                <TableRow key={p.id}>
                  ...
                  <TableCell className="text-right">
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => navigate({ to: `/staff/payroll/periods/${p.id}` })}
                    >
          ...
          <div className="space-y-4 text-sm mt-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <Input
                  type="date"
                  value={newPeriod.cutoffDate}
                  onChange={(e) => setNewPeriod({ ...newPeriod, cutoffDate: e.target.value })}
                />
              </div>
              <div className="space-y-1">
